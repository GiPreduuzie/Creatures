...
namespace CellsAutomate.Creatures
{
    public class SimpleCreature : BaseCreature
    {
        ...
        protected override Tuple<ActionEnum, DirectionEnum> GetCreatureDesires(FoodMatrix eatMatrix, Membrane[,] creatures, Point position, Random random, int energyPoints, int levelOfFood)
        {
